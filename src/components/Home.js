...
{/* <div class="clouds"></div> */}
        ...
        <div className="h-[10%] w-full top-0 flex justify-between z-[100]">
          ...
          <div className="w-[50%]  flex justify-end text-white font-mono">
            <button className="mt-5 mr-7 ml-7 hidden md:block"> Tokenomics </button>
            <button
        ...
        <div className="flex flex-col md:flex-row w-full h-[90vh]">
          <div className="md:w-[60%] w-full pt-[10%] pl-[2%]">
            <h1 className=" text-white  text-xl md:text-6xl drop-shadow-2xl mb-12 font-semibold text-shadow-1">
              <Typewriter
                options={{
                  strings: ["The New Standard For Freedom And Self-Governance"],
                  autoStart: true,
                  loop: true,
                }}
              />
    ...
    <span aria-hidden="true">Powered By</span>
          ...
          muted
          autoPlay
          className="w-[200px] pt-[20%] ml-[33%] mb-[3%] object-cover"
        />
          </div> */}
        </div>
